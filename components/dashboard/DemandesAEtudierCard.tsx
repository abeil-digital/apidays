...
export function DemandesAEtudierCard() {
  ...
  return (
    <Link
      ...
      className="bg-status-warning-bg text-status-warning-fg group flex w-full origin-left items-center gap-3 rounded-xl px-5 py-4 shadow-sm transition-[background-color,box-shadow,transform] duration-200 hover:scale-[1.02] hover:shadow md:max-w-[160px]"
    >
