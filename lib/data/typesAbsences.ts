...
/**
 * Table de référence `types_absences` (2 lignes, CP/RTT) — mise en cache en
 * mémoire, elle ne change pas en cours de session. Partagé entre
 * `demandes.repository.ts` et `reglesConges.repository.ts`, tous deux ayant
 * besoin de résoudre un code ("CP"/"RTT") vers l'id `types_absences`.
 */
